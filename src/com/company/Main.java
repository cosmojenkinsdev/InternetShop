...
public class Main {
    public static void main(String[] args) {
        ...
        BonusAccount bonusAccount2 = new BonusAccount("023", new Owner("Fedor Olegovich", "001"), InstrumentStatus.ACTIVE, 1000);
        System.out.println(bonusAccount2.getOwner().getName() + " " + bonusAccount.pay(new PaymentRequest(500.0, PaymentCategory.ADS, "001")));
